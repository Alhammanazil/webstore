                ...
                <div class="p-4 overflow-y-auto sm:p-7">
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-500 dark:text-neutral-500">
                            Invoice {{ $order ? $order->trx_id : 'N/A' }}
                        </p>
                    </div>
                    ...
                    <div class="mt-5 sm:mt-10">
                        ...
                        @else
                            <div class="flex flex-col items-center justify-center py-8">
                                ...
                                <p class="text-gray-500 dark:text-neutral-400">Order not found</p>
                            </div>
                        @endif
                    </div>
                    ...
                    @if ($order->status == 'App\States\SalesOrder\Pending')
                        ...
                        @else
                            <div
                                class="block w-full px-3 py-2 font-medium text-center text-white bg-gray-400 border border-transparent rounded-lg text-md gap-x-2">
